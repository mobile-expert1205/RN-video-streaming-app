...
const EditProfile = () => {
  ...
  console.log('editdata', initialValues);
  console.log(
    initialValues.email !== undefined && initialValues.email !== ''
      ? false
      : true,
  );
  ...
  const handleUpdate = async values => {
    ...
    try {
      ...
      console.log(initialValues.username, username);
      if (
      ...
      //             .get();
      // console.log("object",userData.empty)
      //           if (userData.empty) {
      //             firestore()
      //               .collection('users')
      //               .doc(firebase.auth().currentUser.uid)
                    ...
                    <VUView flexDirection="row">
                      ...
                      <VUView flex={1} mb={10} width={'50%'}>
                        <VUTextInput
                          ...
                          onBlur={value => setFieldTouched('education', value)}
