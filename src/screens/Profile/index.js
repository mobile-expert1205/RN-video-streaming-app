...
const Profile = ({route = {}}) => {
  ...
  // console.log('localfeedslist', localFeedLsit)
  ...
  const fetchVideos = async () => {
    const loadFeeds = async () => {
      ...
      setIslocalVideo(localFeedLsit.length != 0 ? true : false);
  ...
  useEffect(async () => {
    ...
    const checkinterval = async () => {
      ...
      console.log('localfeedlist>>>>>>', localFeedLsit);
      // console.log('localfeedlist>>>>>>', responseComVideos)
      ...
      if (localFeedLsit.length != 0) {
        ...
        console.log('locallist emptyyyyyyy');
        check = false;
  ...
  useEffect(() => {
    ...
    console.log('myVideosFeeds', myVideosFeeds);
  ...
  const handleOnTabChange = tabIndex => {
    setTab(tabIndex);
    console.log('profilellllll', tabIndex);
  };
  ...
  const renderProcessingLocalFailed = item => {
    ...
    // console.log('checkProcessingUploadlocalVideo', moment().valueOf(), checkProcessingUploadVideo, item.uploadedTime)
    //code here
    return checkProcessingUploadVideo > 0.5 ? (
      <VUImage
        width={24}
