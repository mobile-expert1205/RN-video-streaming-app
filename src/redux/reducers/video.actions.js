...
export const searchVideos = (searchTerm, page) => async (dispatch, getState) => {
  ...
  const { hits, isLast, views } = await algoliaSearchVideos(searchTerm, currentPage);
...
export const setRefreshVideos = (isDeletedLocalVideo) => async (dispatch, getState) => {
  console.log("setRefreshVideos", isDeletedLocalVideo);
